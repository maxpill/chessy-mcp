...
_LOGIC_FILES: tuple[str, ...] = (
    ...
    "mcp_server/domain/__init__.py",
    "mcp_server/domain/action.py",
    "mcp_server/domain/evaluation.py",
    "mcp_server/domain/position.py",
    "mcp_server/domain/rule_status.py",
    "mcp_server/domain/types.py",
    "mcp_server/models/__init__.py",
    "mcp_server/models/mcpeval.py",
    "mcp_server/models/mcpeval_factory.py",
    "mcp_server/models/eval.py",
    "mcp_server/models/action.py",
    "mcp_server/models/history.py",
    "mcp_server/models/policy.py",
