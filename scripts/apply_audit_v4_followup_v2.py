...
if best_start in text:
    ...
    end = text.index(outer_terminal, start) + 2
    replacement = '''    is_engine_best = move_uci.lower() == (eval_before.best_move or "").lower()\n\n'''
    analysis.write_text(text[:start] + replacement + text[end:], encoding="utf-8")
